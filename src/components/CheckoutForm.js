...
const PayButtonText = tw.div`bg-blue-500 hover:bg-blue-600 text-white font-semibold py-2 px-4 rounded my-5`;
  ...
  const handleSubmit = async (e) => {
    ...
    const { error } = await stripe.confirmPayment({
      ...
      confirmParams: {
        ...
        return_url: process.env.REACT_APP_URL + `/payment_result/${appointmentId}`,
      },
    });
